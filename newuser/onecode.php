      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">聚合收款</h4>
                  <p class="card-subtitle mb-4">在此处配置你的收款码</p>
                  <!---->
...
<p>商家只需要一个固定的二维码，就可以完成支付宝、微信、QQ等主流支付方式的收款，方便快捷。</p>
	...
	<div class="panel panel-default">
		<div class="panel-heading font-bold">
			<i class="fa fa-qrcode"></i>&nbsp;你的聚合收款码	<a href="javascript:;" id="downImg" class="btn btn-success btn-sm">长按图片或点我保存</a>
		</div>
		<div class="panel-body text-center">
			...
			<div class="hide">
				<canvas style="width:260px;" id="canvas"></canvas>
			</div>
		<!--</div>-->
	</div>
	</div>
