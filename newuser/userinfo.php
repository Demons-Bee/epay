...
<ul class="nav nav-tabs">
	<li style="width: 25%;" align="center" class="btn btn-link waves-effect">
...
<?php if($mod=='api'){?>
			<form class="form-horizontal devform">
				<div class="card-subtitle mb-4"><p></p>
					<label class="col-sm-2 control-label">接口地址</label>
					<div class="col-sm-9">
						<div class="input-group"><input class="form-control" type="text" value="<?php echo $conf['apiurl']?>" readonly><div class="input-group-addon"><a href="javascript:;" class="copy-btn" data-clipboard-text="<?php echo $conf['apiurl']?>" title="点击复制"><div class="input-group-prepend">
                                                <button class="btn btn-primary dropdown-toggle waves-effect waves-light" type="button"><i class="fa fa-copy"></i></button>
                                            </div></a></div></div>
					</div>
				<!--</div>-->
				<div class="form-group"><p></p>
					...
					<div class="col-sm-9">
						<div class="input-group"><input class="form-control" type="text" value="<?php echo $uid?>" readonly><div class="input-group-addon"><a href="javascript:;" class="copy-btn" data-clipboard-text="<?php echo $uid?>" title="点击复制"><div class="input-group-prepend">
                                                <button class="btn btn-primary dropdown-toggle waves-effect waves-light" type="button"><i class="fa fa-copy"></i></button>
                                            </div></a></div></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group"><input class="form-control" type="text" value="<?php echo $userrow['key']?>" readonly><div class="input-group-addon"><a href="javascript:;" class="copy-btn" data-clipboard-text="<?php echo $userrow['key']?>" title="点击复制"><div class="input-group-prepend">
                                                <button class="btn btn-primary dropdown-toggle waves-effect waves-light" type="button"><i class="fa fa-copy"></i></button>
                                            </div></a></div></div>
					</div>
				</div>
...
<?php }elseif($mod=='account'){?>
			<form class="form-horizontal devform"><p></p>
